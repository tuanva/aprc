 ...
 * Time: 19:44
 */
public class ATMSimulationAdvanceTest {
    ...
    public void testRandomTakingOff() {
        ...
        for (int i = 0; i < tmp; i++) {
//                System.out.println("======= Begin tick " + i + "=======");
            sim.tick();
        }

        String expectedPlaneName = String.format("%s_%03d", a.getCode(), tmp);
//            System.out.println("Expected: " + expectedPlaneName);
